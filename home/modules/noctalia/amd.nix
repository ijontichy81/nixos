  ...
  programs.noctalia-shell = {
    ...
    settings = {
      ...
      systemMonitor = {
        ...
        warningColor = "";
        criticalColor = "";
        externalMonitor = "resources || missioncenter || jdsystemmonitor || corestats || system-monitoring-center || gnome-system-monitor || plasma-system-monitor || mate-system-monitor || ukui-system-monitor || pantheon-system-monitor";
      };
      noctaliaPerformance = {
